...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemOne()
        {
            ...
            // HINT: .ToList().Count
            var thing  = _context.Users.ToList().Count;
        ...
        private void ProblemThree()
        {
            ...
            var productsOver = products.Where(p => p.Price >= 150);
            foreach (var product in productsOver)
            {
        ...
        private void ProblemFive()
        {
            ...
            var earlyUsers = _context.Users.Where(p => p.RegistrationDate < new DateTime(2016, 1, 1));
        ...
        private void ProblemSix()
        {
            ...
            var earlyUsers = _context.Users.Where(p => p.RegistrationDate > new DateTime(2015, 12, 31 ) && p.RegistrationDate < new DateTime(2018, 1,1));
    ...
    private void ProblemSeven()
        ...
        private void ProblemEight()
        {
            ...
            var customerCart = _context.ShoppingCarts.Include(sc =>sc.Product).Where(sc => sc.User.Email == "afton@gmail.com");
        ...
        private void ProblemNine()
        {
            ...
            var customercart = _context.ShoppingCarts.Include(sc => sc.Product).Where(sc => sc.User.Email == "oda@gmail.com").Select(sc => sc.Product.Price).Sum();
